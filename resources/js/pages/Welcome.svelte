...
<script lang="ts">
    ...
    const startLabel = 'ابدأ — دقيقتين وبس';

    const BENEFITS = [
        {
            icon: CalendarCheck,
            title: 'كم يصفى لك اليوم',
            detail: 'رقم واحد واضح تصرف منه اليوم بأمان — لا جدول ولا حساب.',
            color: 'var(--chart-3)',
        },
        {
            icon: ShieldCheck,
            title: 'التزاماتك محجوزة',
            detail: 'الإيجار والأقساط تُطرح قبل ما تصرف — فما تتفاجأ آخر الشهر.',
            color: 'var(--chart-1)',
        },
        {
            icon: FileText,
            title: 'تقرير شهري يوضّح وين راحت',
            detail: 'كل شهر راتب يُقفل بملخّص: دخل، صرف، ادخار، وفائض.',
            color: 'var(--chart-7)',
        },
    ];
</script>
